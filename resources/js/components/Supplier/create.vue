        ...
        <div class="row container">
            <div class="card col-lg-12">
                <div class="card-header">
                    ...
                    Employee Insert
                    <router-link to="/all-supplier"  class="btn btn-sm btn-info" id="add_emp"> All Supplier</router-link>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" @submit.prevent="supplierInsert()">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input v-model="form.shopname" type="text"  class="form-control"  autofocus="autofocus">
