        ...
        <div class="row container">
            <div class="card col-lg-12">
                <div class="card-header">
                    ...
                    Employee Insert
                    <router-link to="/all-employee"  class="btn btn-sm btn-info" id="add_emp"> All Employee</router-link>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" @submit.prevent="employeeInsert()">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-label-group">
                                        <input v-model="form.joinning_date" type="date"  class="form-control"  autofocus="autofocus">
                                        <small class="text-danger" v-if="errors.joinning_date">{{errors.joinning_date[0]}}</small>
                                        <label for="firstName">Joining Date</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-label-group">
                                        <input v-model="form.nid" id="nid" type="text"  class="form-control">
