<template>
    <div>
        ...
        <div class="row ">
                ...
                <div class="cart-body">
                    <table class="table table-sm table-striped">
                        ...
                        <tr v-for="cart in carts" :key="cart.id">
                            ...
                            <td><input type="text" readonly="" style="width: 20px;" :value="cart.product_quantity">

                                <button @click.prevent="increment(cart.id)" class="btn btn-sm btn-success">+</button>
                                <button v-if="cart.product_quantity >= 2 " @click="decrement(cart.id)" class="btn btn-sm btn-danger">-</button>
                                <button v-else="cart.product_quantity <2" class="btn btn-sm btn-danger" disabled>-</button>
                ...
                <div class="cart-footer">
                    ...
                    <form @submit.prevent="orderDone()">
                        ...
                        <select class="form-control" v-model="payby">
                            ...
                            <option value="Giftcart">Gift cart</option>
                        </select>
            ...
            <!--&lt;!&ndash;end customer modal&ndash;&gt;-->

            <div class="cart col-lg-7">
                <div class="cart-header">
                    <i class="fas fa-chart-area"></i>
                    Products
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="product in filtersearch" :key="product.id">
                                    <button class="btn bt-sm" @click.prevent="AddToCart(product.id)">
                                        <div class="cart" style="width: 9rem; height: 180px;">
                                            <img :src="product.image" class="cart-img-top" style="height: 100px; width: 100px;">
                                            <div class="cart-body">
                                                <small class="cart-title">{{ product.product_name }}</small><br>
                                                <span class="badge badge-success" v-if="product.product_quantity >10"> Availble ({{ product.product_quantity }}) </span>
                                                <span class="badge badge-warning" v-else-if="product.product_quantity >=1 && product.product_quantity <=10"> Nearly Stock Out ({{ product.product_quantity }}) </span>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-6" v-for="getproduct in getfiltersearch" :key="getproduct.id">
                                    <button class="btn btn-sm" @click.prevent="AddToCart(getproduct.id)">
                                        <div class="cart" style="width: 9rem; height: 180px;">
                                            <img :src="getproduct.image" class="cart-img-top" style="height: 100px; width: 100px;">
                                            <div class="cart-body">
                                                <small class="cart-title">{{ getproduct.product_name }}</small><br>
                                                <span class="badge badge-success" v-if="getproduct.product_quantity >10"> Availble ({{ getproduct.product_quantity }}) </span>
                                                <span class="badge badge-warning" v-else-if="getproduct.product_quantity >=1 && getproduct.product_quantity <=10"> Nearly Stock Out ({{ getproduct.product_quantity }}) </span>
