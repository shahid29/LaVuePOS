        ...
        <div class="row container">
            <div class="card col-lg-12">
                <div class="card-header">
                    ...
                    Pay Employee Salary
                    <router-link to="/given-salary"  class="btn btn-sm btn-info" id="add_emp"> Salary</router-link>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" @submit.prevent="salaryPay()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-label-group">
                                    <input v-model="form.salary" id="lastName1" type="text" class="form-control" >
            ...
            salaryPay(){
                ...
                axios.post('/api/salary/paid/'+id,this.form)
                    .then(res=>{
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Salary Given Successfully'
                        })
                    })
